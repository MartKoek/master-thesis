...
""" Set variables """
modality = 'unimodal'
n_splits = 7  # The number of folds
models = ['sbert_all-MiniLM-L12-v2', 'pdem_wav2vec']
pre_list = ['sbert', 'w2v']
...
for f_list in list_combos_functionals:
    ...
    for k in k_list:
        for c in c_list:
            ...
            new_row_overall_SBERT = [root_mean_squared_error(overall_severity_vec, overall_pred_sev_SBERT)]
            new_row_overall_W2V = [root_mean_squared_error(overall_severity_vec, overall_pred_sev_W2V)]
